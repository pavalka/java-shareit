...
class BookingControllerTest {
    ...
    @Test
    void createNewBookingReturnStatus400WhenIdIsNull() throws Exception {
        var creatingTime = LocalDateTime.now().plusHours(1);
        var incomingBookingDto = createIncomingBookingDto(null, creatingTime);
    ...
    @Test
    void createNewBookingReturnStatus400WhenStartIsNull() throws Exception {
        var creatingTime = LocalDateTime.now().plusHours(1);
    ...
    @Test
    void createNewBookingReturnStatus400WhenStartIsInPast() throws Exception {
        var creatingTime = LocalDateTime.now();
        var incomingBookingDto = createIncomingBookingDto(1L, creatingTime);

        incomingBookingDto.setStart(creatingTime.minusHours(1));
        mvc.perform(post("/bookings")
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON)
                        .header("X-Sharer-User-Id", 1)
    ...
    @Test
    void createNewBookingReturnStatus400WhenEndIsInPast() throws Exception {
        var creatingTime = LocalDateTime.now().plusHours(1);
        var incomingBookingDto = createIncomingBookingDto(1L, creatingTime);

        incomingBookingDto.setEnd(creatingTime.minusHours(2));
        mvc.perform(post("/bookings")
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON)
                        .header("X-Sharer-User-Id", 1)
    ...
    @Test
    void createNewBookingReturnStatus400WhenEndIsNull() throws Exception {
        var creatingTime = LocalDateTime.now().plusHours(1);
        var incomingBookingDto = createIncomingBookingDto(1L, creatingTime);
    ...
    @Test
    void setBookingStatusReturnStatus500WhenEndpointIsIncorrect() throws Exception {
        mvc.perform(patch("/bookings?approved=true")
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON)
                        .header("X-Sharer-User-Id", 1))
    ...
    @Test
    void getBookingByIdReturnStatus400WhenHeaderIsAbsent() throws Exception {
        mvc.perform(get("/bookings/1")
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isBadRequest())
    ...
    @Test
    void getBookingByIdReturnStatus400WhenPathVariableIsIllegal() throws Exception {
        mvc.perform(get("/bookings/m")
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON)
                        .header("X-Sharer-User-Id", 1))
                .andExpect(status().isBadRequest())
    ...
    @Test
    void getBookingsByUserAndStateReturnStatus200AndBookingWhenParamStateIsNotPresent() throws Exception {
        var itemOwner = createUser();
        var item = createItem(itemOwner);
        var bookingAuthor = createUser();
        var creatingTime = LocalDateTime.now().plusHours(1);
        ...
        Mockito.when(bookingService.getAllBookingsByUserAndState(1, BookingState.ALL, 0, 2))
                .thenReturn(List.of(outgoingBookingDto));

        mvc.perform(get("/bookings?from=0&size=2")
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON)
                        .header("X-Sharer-User-Id", 1))
                .andExpect(status().isOk())
    ...
    @Test
    void getBookingsByUserAndStateReturnStatus400WhenParamFromIsNegative() throws Exception {
        mvc.perform(get("/bookings?state=WAITING&from=-1&size=2")
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON)
                        .header("X-Sharer-User-Id", 1))
                .andExpect(status().isBadRequest())
    ...
    @Test
    void getBookingsByUserAndStateReturnStatus400WhenParamSizeIsNegative() throws Exception {
    ...
    @Test
    void getBookingsByUserAndStateReturnStatus400WhenParamSizeIsZero() throws Exception {
        mvc.perform(get("/bookings?state=WAITING&from=1&size=0")
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON)
                        .header("X-Sharer-User-Id", 1))
                .andExpect(status().isBadRequest())
    ...
    @Test
    void getBookingsByUserAndStateReturnStatus400WhenParamStateIsNotLegalBookingState() throws Exception {
        mvc.perform(get("/bookings?state=OTHER&from=1&size=1")
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON)
                        .header("X-Sharer-User-Id", 1))
                .andExpect(status().isBadRequest())
    ...
    @Test
    void getBookingsByOwnerAndStateReturnStatus200AndBookingWhenParamStateIsNotPresent() throws Exception {
        var itemOwner = createUser();
        var item = createItem(itemOwner);
        var bookingAuthor = createUser();
        var creatingTime = LocalDateTime.now().plusHours(1);
        ...
        Mockito.when(bookingService.getAllBookingsByOwnerAndState(1, BookingState.ALL, 0, 2))
                .thenReturn(List.of(outgoingBookingDto));
    ...
    @Test
    void getBookingsByOwnerAndStateReturnStatus400WhenParamFromIsNegative() throws Exception {
        mvc.perform(get("/bookings/owner?state=WAITING&from=-1&size=2")
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON)
                        .header("X-Sharer-User-Id", 1))
                .andExpect(status().isBadRequest())
    ...
    @Test
    void getBookingsByOwnerAndStateReturnStatus400WhenParamSizeIsNegative() throws Exception {
        mvc.perform(get("/bookings/owner?state=WAITING&from=1&size=-2")
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON)
                        .header("X-Sharer-User-Id", 1))
    ...
    @Test
    void getBookingsByOwnerAndStateReturnStatus400WhenParamSizeIsNull() throws Exception {
        mvc.perform(get("/bookings/owner?state=WAITING&from=1&size=0")
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON)
                        .header("X-Sharer-User-Id", 1))
                .andExpect(status().isBadRequest())
    ...
    @Test
    void getBookingsByOwnerAndStateReturnStatus400WhenParamStateHasIllegalValue() throws Exception {
        mvc.perform(get("/bookings/owner?state=OTHER&from=1&size=0")
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON)
                        .header("X-Sharer-User-Id", 1))
                .andExpect(status().isBadRequest())
